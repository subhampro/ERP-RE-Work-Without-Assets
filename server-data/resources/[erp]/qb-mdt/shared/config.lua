...
Config.RosterLink = {
    ['police'] = 'https://docs.google.com/spreadsheets/d/12RmR01iQ_eK6BpcMVsIkbI4-UNXUeYxOkFOvgrYq5M4/edit#gid=1806219984',
    ['ambulance'] = '',
    ['bcso'] = '',
    ['doj'] = '',
}
...
Config.PenalCode = {
    [1] = {
        ...
        [22] = {title = 'Criminal Threats', class = 'Misdemeanor', id = 'P.C. 1022', months = 8, fine = 4500, color = 'orange'},
    ...
    [6] = {
        [1] = {title = 'Disobeying a Peace Officer', class = 'infraction', id = 'P.C. 6001', months = 5, fine = 2500, color = 'green'},

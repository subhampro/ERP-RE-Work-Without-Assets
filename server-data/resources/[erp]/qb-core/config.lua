...
QBConfig.UpdateInterval = 4 -- how often to update player data in minutes
QBConfig.StatusInterval = 5000 -- how often to check hunger/thirst status in milliseconds
QBConfig.IdentifierType = "license" -- Set the identifier type (can be: steam, license)
...
QBConfig.Server.Discord = "https://discord.gg/RCrVd2HPfA" -- Discord invite link

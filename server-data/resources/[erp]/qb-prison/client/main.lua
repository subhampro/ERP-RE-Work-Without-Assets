...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
	...
	freedom_ped = CreatePed(0, pedModel , 1775.74, 2553.61, 44.57, 86.7, false, true) 
	...
	canteen_ped = CreatePed(0, pedModel, 1780.97, 2560.69, 44.67, 182.73, false, true)
...
RegisterNetEvent('prison:client:Enter', function(time)
	...
	Wait(500)
	TriggerEvent('dpemote:custom:animation', {RandomStartPosition.animation})

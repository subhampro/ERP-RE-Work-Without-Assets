...
AddEventHandler("qb-lumberjack:client:cutjack", function()
    QBCore.Functions.Progressbar("cut_wood", Config.Alerts["cut_wood"], 10000, false, true, {
...
AddEventHandler("qb-lumberjack:client:processwood", function ()
    QBCore.Functions.TriggerCallback('qb-lumberjack:server:get:proccesswood', function(wood)  
        if wood then
            QBCore.Functions.Progressbar("process_wood", Config.Alerts["proc_wood"], 10000, false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,

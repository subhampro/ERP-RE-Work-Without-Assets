...
Config.TruckPrice = 350

-- Want to give out a cryptostick per stop?
Config.GiveCryptoStick = true
Config.GiveWater = true
Config.GiveBread = true
Config.GivePistol = true
Config.GivePistolammo = true
Config.Givekevlarfiber = true
Config.Givepotassium = true
Config.Giveechip = true


-- Has to roll this number or higher to receive a cryptostick
Config.CryptoStickChance = 89
Config.waterChance = 50
Config.BreadChance = 45
-- Config.pistolChance = 185
Config.pistolChance = 99
Config.PistolammoChance = 90
Config.kevlarfiberChance = 90
Config.potassiumChance = 70
Config.echipChance = 85
...
-- Upper worth per bag
Config.BagUpperWorth = 70

-- Lower worth per bag
Config.BagLowerWorth = 60

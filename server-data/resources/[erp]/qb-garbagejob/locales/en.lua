local Translations = {
    ...
    info = {
        ...
        ["found_waterbottle"] = "You found a water bottle on the floor",
        ["found_bread"] = "You found a Grilled tosti on the floor",
        ["found_pistol"] = "Hoowwwweeee !! 😱 You found a Pistol on the floor",
        ["found_pistolammo"] = "You found Pistol Ammo on the floor",
        ["found_kevlarfiber"] = "You found a piece of kevlarfiber",
        ["found_potassium"] = "You found Potassium Nitrate🔥",
        ["found_echip"] = "You found Electronickit 🔥",
    },

...
Config.MinimumTime = 25
Config.MaximumTime = 45  

Config.Rewards = {
    [1] = {
        ["cabin"] = {"plastic", "gold_earing", "gold_bracelet", "weed_skunk", "weapon_golfclub", "sandwich"},
        ["kitchen"] = {"burger", "sandwich", "gold_bracelet","plastic", "water_bottle"},
        ["chest"] = {"emptydropphone", "plastic", "rolex", "gold_bracelet", "weed_skunk", "trojan_usb", "pistol_ammo","sandwich"},
        ["livingroom"] = {"plastic", "rolex","gold_bracelet", "tablet", "pistol_ammo", "water_bottle"}
    }
}

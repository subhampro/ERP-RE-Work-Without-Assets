...
local function SetInApartmentTargets()
    ...
    local entrancePos = vector3(Apartments.Locations[ClosestHouse].coords.enter.x - POIOffsets.exit.x  + 9.9, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.exit.y  + 8.7, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentOffset + POIOffsets.exit.z)
    local stashPos = vector3(Apartments.Locations[ClosestHouse].coords.enter.x - POIOffsets.stash.x -1.5, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.stash.y -3.9, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentOffset + POIOffsets.stash.z)
    local outfitsPos = vector3(Apartments.Locations[ClosestHouse].coords.enter.x - POIOffsets.clothes.x -3, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.clothes.y -13.0, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentOffset + POIOffsets.clothes.z)
    local logoutPos = vector3(Apartments.Locations[ClosestHouse].coords.enter.x - POIOffsets.logout.x - 3.8, Apartments.Locations[ClosestHouse].coords.enter.y + POIOffsets.logout.y - 0.95 , Apartments.Locations[ClosestHouse].coords.enter.z - CurrentOffset + POIOffsets.logout.z)

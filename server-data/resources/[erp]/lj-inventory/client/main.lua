...
RegisterCommand('inventory', function()
    if not isCrafting and not inInventory then
        if not PlayerData.metadata["isdead"] and not PlayerData.metadata["inlaststand"] and not PlayerData.metadata["ishandcuffed"] and not IsPauseMenuActive() and not IsEntityPlayingAnim(PlayerPedId(), "missminuteman_1ig_2", "handsup_base", 3) then
            local ped = PlayerPedId()
            local curVeh = nil
...
CreateThread(function()
    ...
    -- local toolBoxModels = {
    --     `prop_toolchest_05566`,
    --     `prop_tool_bench02_ld656`,
    --     `prop_tool_bench02656`,
    --     `prop_toolchest_02656`,
    --     `prop_toolchest_036566`,
    --     `prop_toolchest_03_l265`,
    --     `prop_toolchest_0565`,
    --     `prop_toolchest_0465`,
    -- }

...
QBCore.Functions.CreateCallback('erp-ai_medic:docOnline', function(source, cb)
	local src = source
...
RegisterServerEvent('erp-ai_medic:charge')
AddEventHandler('erp-ai_medic:charge', function()
	local src = source

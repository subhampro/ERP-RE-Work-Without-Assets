...
function InitiateMenus(isMotorcycle, vehicleHealth)
    ...
    --#[Main Menu]#--
    createMenu("mainMenu", "Welcome to ERP Customs", "Choose a Category")
        ...
        if amountValidMods > 0 or v.id == 18 then
            if v.id == 0 or v.id == 1 or v.id == 2 or 
               ...
               v.id == 9 or v.id == 10 then
                --recruit
                if plyjob.name == 'mechanic' and plyjob.grade.level >= 1 and plyjob.onduty or plyjob.name == 'bigboss' or plyjob.name == 'tunner' then
            ...
            elseif v.id == 11 or v.id == 12 or v.id == 13 or 
                   ...
                   v.id == 47 or v.id == 49 then
                    --vetern
                    if plyjob.name == 'mechanic' and plyjob.grade.level >= 2 and plyjob.onduty or plyjob.name == 'bigboss' or plyjob.name == 'tunner' then
                        populateMenu("mainMenu", v.id, v.category, "none")
                    end
            elseif v.id == 11 or v.id == 12 or v.id == 13 or 
                   ...
                   v.id == 18 or v.id == 48 then
                    --expert
                    if plyjob.name == 'mechanic' and plyjob.grade.level >= 3 and plyjob.onduty or plyjob.name == 'bigboss' or plyjob.name == 'tunner' then
                        populateMenu("mainMenu", v.id, v.category, "none")
                    end
            elseif v.id == 14 then
                --public
    ...
    if not isMotorcycle then
        ...
        if plyjob.name == 'mechanic' and plyjob.grade.level >= 4 and plyjob.onduty or plyjob.name == 'bigboss' or plyjob.name == 'tunner' then
    ...
    if livCount > 0 then
        ...
        createMenu("OldLiveryMenu", "Livery Customisation", "Choose a Livery")

...
bennyGarages = {
    ...
    [1] = {coords = vector4(-339.04, -95.02, 38.38, 70.86), useJob = true, job = {"mechanic"}},
    [2] = {coords = vector4(-352.42, -90.35, 38.38, 70.66), useJob = true, job = {"mechanic"}},
    [3] = {coords = vector4(-365.88, -85.62, 38.38, 70.69), useJob = true, job = {"mechanic"}},
    -- [5] = {coords = vector4(-211.33, -1324.68, 30.58, 319.12), useJob = false, job = {"mechanic"}},
    -- [6] = {coords = vector4(1175.1, 2641.14, 37.68, 1.05), useJob = false, job = {"mechanic"}},
    -- [7] = {coords = vector4(111.6, 6625.86, 31.71, 224.08), useJob = false, job = {"mechanic"}},
    -- [8] = {coords = vector4(845.19, -3238.7, -99.18, 256.73), useJob = true, job = {"bigboss"}},
    -- [9] = {coords = vector4(-1364.37, 160.84, -99.71, 269.04), useJob = true, job = {"tunner"}},
}
--[[ bennyLocations = {
...
vehicleCustomisationPrices = {
    cosmetics = {price = 2000},
    respray = {price = 500},
    performance = {prices = {2000, 3250, 5500, 13450, 15250, 17500}},
    turbo = {price = 13000},
    wheels = {price = 1000},
    customwheels = {price = 1500},
    wheelsmoke = {price = 1500},
    windowtint = {price = 1000},
    neonside = {price = 500},
    neoncolours = {price = 1000},
    headlights = {price = 2000},

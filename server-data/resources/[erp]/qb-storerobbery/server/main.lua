...
RegisterNetEvent('qb-storerobbery:server:SafeReward', function(safe)
	...
	Player.Functions.AddItem("goldbar", 16)
...
RegisterNetEvent('qb-storerobbery:server:callCops', function(type, safe, streetLabel, coords)
    ...
    TriggerEvent("qb-log:server:CreateLog", "storerobbery", "Store Robbery", "orange", "**Steam     : **"..GetPlayerName(source)..
                                                                                                  "\n**Player  :** "..Player.PlayerData.charinfo.firstname.." "..Player.PlayerData.charinfo.lastname..
                                                                                                  "\n**Street : ** " ..streetLabel, false)
end)

...
AddEventHandler('onClientResourceStart', function (RES)
    ...
    if FIREAC.AntiResourceRestarter then
        if SPAWN then
...
AddEventHandler("gameEventTriggered", function(name, args)
    ...
    --             TriggerServerEvent('FIREAC:BanFromClient', FIREAC.AimBotPunishment, "Aim Hacking Its Under Development IGNORE IT", "Shot Player Without Being On His Screen (DIS : ".._distance..")")
    --         end

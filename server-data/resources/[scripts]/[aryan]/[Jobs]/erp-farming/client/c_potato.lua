...
RegisterNetEvent('erp-farming:client:HarvestPotato', function()
    ...
    if Config.New_Core then 
        ...
        if trowel then
            ...
            QBCore.Functions.Progressbar("get_item",'Harvesting Potatoes...', Config["ProgressBarTime"]["Harvest"], false, true, {
            ...
            TriggerServerEvent('erp-farming:server:GetPotato')
            end, function()
                TriggerEvent('dpemote:custom:animation', {"c"})    
            end)
        else

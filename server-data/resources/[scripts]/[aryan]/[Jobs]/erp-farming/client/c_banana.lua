...
RegisterNetEvent('erp-farming:client:PickBanana', function()
    ...
    if Config.New_Core then 
        ...
        if fruit_picker then
            ...
            QBCore.Functions.Progressbar("get_item","Picking Banana's...", Config["ProgressBarTime"]["Harvest"], false, true, {
            ...
            TriggerServerEvent('erp-farming:server:GetBanana')
            end, function()
                TriggerEvent('dpemote:custom:animation', {"c"})    
            end)
        else

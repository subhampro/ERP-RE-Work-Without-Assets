...
RegisterNetEvent('erp-farming:client:HarvestPumpkin', function()
    ...
    if Config.New_Core then 
        ...
        if trowel then
            ...
            QBCore.Functions.Progressbar("get_item",'Harvesting Pumpkin...', Config["ProgressBarTime"]["Harvest"], false, true, {
            ...
            TriggerServerEvent('erp-farming:server:GetPumpkin')
            end, function()
                TriggerEvent('dpemote:custom:animation', {"c"})    
            end)
        else

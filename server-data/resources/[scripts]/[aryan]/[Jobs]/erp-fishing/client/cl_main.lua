...
local fishAnimation = function()
    -- Remove Fishing Bait
    TriggerServerEvent('erp-fishing:server:RemoveBait')
    ...
    exports['ps-ui']:Circle(function(success)
        if success then
            ...
            TriggerServerEvent('erp-fishing:server:ReceiveFish')
        else
...
RegisterNetEvent('erp-fishing:client:FishingRod', function()
...
CreateThread(function()
    ...
    for k, v in pairs(Shared.Fishing) do

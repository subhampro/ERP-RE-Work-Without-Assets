...
RegisterNetEvent('erp-fishing:client:OpenSale', function()
    -- Anti spam
    ...
    for k, v in pairs(items) do
        if fish[v.name] then
            ...
            menu[#menu+1] = {
                ...
                params = {
                    event = "erp-fishing:client:SellFish",
                    args = v.name
                },
            }
        end
...
RegisterNetEvent('erp-fishing:client:SellFish', function(itemName)
    ...
    QBCore.Functions.TriggerCallback('erp-fishing:server:CanSell', function(result)
        if result then
            -- Anti spam
            if isSelling then return end
            isSelling = true
            ...
            -- Sell Fish
            TriggerServerEvent('erp-fishing:server:SellFish', itemName, tonumber(sellingAmount.amount))
...
CreateThread(function()
    ...
    exports['qb-target']:AddTargetEntity(ped, {
        options = {
            {
                type = "client",
                event = "erp-fishing:client:OpenSale",

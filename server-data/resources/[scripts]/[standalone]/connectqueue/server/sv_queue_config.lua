...
Config.Priority = {
    ["steam:110000137972c5f"] = 25,
    ["steam:110000148723f46"] = 25,
    -- ["ip:127.0.0.0"] = 85
}
...
Config.ConnectTimeOut = 800

-- will remove players from queue if the server doesn't recieve a message from them within: __ seconds
Config.QueueTimeOut = 480
...
Config.Language = {
    ...
    steam = "\xE2\x9D\x97 [Queue] Error: Steam APP must be running in Background"
}

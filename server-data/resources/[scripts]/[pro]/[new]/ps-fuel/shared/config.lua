...
Config.BlowUpChance = 15 -- percentage for chance of engine explosion
Config.RefillCost = 200 -- default price
Config.CostMultiplier = 9.0 -- tax basically
Config.canCost = 2000 -- buy jerry can price
Config.refuelCost = 1000 -- refueling jerry can price
Config.GlobalTax = 9.0

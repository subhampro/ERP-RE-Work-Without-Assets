...
Config.RequirePlayersOnBothTeams = false -- change this to true if you dont want there to be players on both teams to be able to start the match
...
Config.MaxTeam = 15 -- i wouldnt change this
Config.MaxLives = 5 -- Maximum amount of lives players can set
Config.MinWager = 1000 -- minimum bet players can make
Config.MaxWager = 1250000 -- maximum bet players can make
...
Config.Pistols = {
    ...
    [2] = {
        description = QBCore.Shared.Items['weapon_snspistol']["description"],

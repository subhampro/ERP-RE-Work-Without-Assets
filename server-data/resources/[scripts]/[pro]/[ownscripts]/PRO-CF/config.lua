...
Config.Weapons= {
    ...
    --Assault Rifles--
    [38] = { hash = `WEAPON_ASSAULTRIFLE`, recoil = 1.50, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.40, suppressorMultiplier = 0.72, damageMultiplier = 0.50},
    ...
    -- [101] = { hash = `WEAPON_PETROLCAN`, recoil = 0.0, rightLeftRecoil = 0.0, vehicleRecoil = 0.0, vehicleRightLeftRecoil = 0.0, gripMultiplier = 0.0, suppressorMultiplier = 0.0, damageMultiplier = 0.0},

...
RegisterNetEvent('PRO-text:client:DrawText', function(text, position,r,g,b,a)
    DrawText(text, position,r,g,b,a)
end)

RegisterNetEvent('PRO-text:client:ChangeText', function(text, position)
    ChangeText(text, position)
end)

RegisterNetEvent('PRO-text:client:HideText', function()
    HideText()
end)

RegisterNetEvent('PRO-text:client:KeyPressed', function()
    KeyPressed()
end)

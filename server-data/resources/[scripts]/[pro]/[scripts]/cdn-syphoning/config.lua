...
-- Police Stuff --
Config.SyphonPoliceCallChance = 50 -- Math.Random(1, 100) Default: 25% 
Config.SyphonDispatchSystem = "qb-dispatch" -- Options: "ps-dispatch", "qb-dispatch", "qb-default" (just blips) or "custom" (Custom: you must configure yourself!)
-- Anims --

...
Citizen.CreateThread(function()
    while true do
        ...
        local letSleep = 1000
        local Distance = #(pedCo - vector3(218.47, 106.4, 100.75))
...
AddEventHandler("CL-ThermiteMission:SpawnTruck", function()
    local coords = vector4(-1810.41, 2964.91, 32.17, 59.9)
...
function CheckCoords()
    Citizen.CreateThread(function()
        while true do
            ...
            local Distance = GetDistanceBetweenCoords(PlayerCoords, -1858.96, 2995.49, 32.81, true) 
...
function MissionBlip()
    local Mblip = AddBlipForCoord(-1810.41, 2964.91, 32.17, 59.9)

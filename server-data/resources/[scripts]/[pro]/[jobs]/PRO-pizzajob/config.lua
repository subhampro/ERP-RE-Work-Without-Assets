...
Config.Payment = math.random(430, 455)

Config.BossCoords = vector4(793.7, -748.67, 26.09, 93.62)

Config.Vehicle = "blazer3"

Config.VehicleSpawn = vector4(790.79, -745.73, 26.8, 0.29)
